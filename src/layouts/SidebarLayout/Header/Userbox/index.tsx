...
import { checkLoggedInUser, getStorageData, logoutUser } from '@/utils';
...
function HeaderUserbox() {
  ...
  const goToLogin = (): void => logoutUser();
        ...
        isLoggedIn ? (<>
          ...
          >
            ...
            <List sx={{ p: 1 }} component="nav">
              <NextLink href={isAdmin ? '/admin/profile' : '/user/profile'} passHref>
                <ListItem button>
          ...
          <UserBoxButton color="success" ref={ref} onClick={goToLogin}>
            <LoginTwoTone />
            <Hidden mdDown>
              <UserBoxText>
                <UserBoxLabel variant="body1">Login</UserBoxLabel>
              </UserBoxText>
            </Hidden>
          </UserBoxButton>
        </>)
